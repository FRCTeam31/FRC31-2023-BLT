...
public class EndEffectorCommands {
     ...
     * @return
     */
    public static Command intakeGamePiece(Shoulder shoulder, Wrist wrist, Forearm forearm, IntakeDirection direction) {
    ...
    /**
     * Score cube by setting the shoulder angle, forearm extension, and wrist angle
     ...
     * @return
     */
    public static Command scoreCube(Shoulder shoulder, Wrist wrist, Forearm forearm, ShoulderLevels level) {
        return new SequentialCommandGroup(
                ShoulderCommands.setAngle(shoulder, level),
                // TODO: Set forearm extend distance
                WristCommands.setWristAngle(wrist, IntakeDirection.kCone), // TODO: Verify this is the right setting
                WristCommands.runUntilTimeout(wrist, 1, WristMap.kEjectCubeSpeed),
                WristCommands.stopIntake(wrist));
    }

    /**
     * Score cone by setting the shoulder angle and forearm extension, then ejecting
     * for 1 second
     * 
     * @param shoulder The shoulder of the robot
     * @param wrist    The wrist of the robot
     ...
     * @return
     */
    public static Command scoreCone(Shoulder shoulder, Wrist wrist, Forearm forearm, ShoulderLevels level) {
        return new SequentialCommandGroup(
                ShoulderCommands.setAngle(shoulder, level),
                // TODO: Set forearm extend distance
                WristCommands.setWristAngle(wrist, IntakeDirection.kCone), // TODO: Verify this is the right setting
